...
export const StarAiIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path fillRule="evenodd" d="M12 1.5L8.6 8.5H1.3l5.9 4.3-3 9.7L12 17.5l7.8 5-3-9.7 5.9-4.3h-7.3L12 1.5zM12 5.2l-1.6 4.8H5.5l3.8 2.8-1.1 6.5L12 16.8l3.8 2.5-1.1-6.5 3.8-2.8h-4.9L12 5.2z"/>
        <path d="M8.2,14.2c1.9-1.9,4.4-2.9,7-2.9l1-1.7c-2.8,0-5.6,1.1-7.6,3.1l-1.9,3.1c1,1.8,2.6,3.1,4.4,3.7l1-1.7c-1.3-.5-2.5-1.3-3.3-2.5L8.2,14.2z"/>
    </svg>
);
...
export const LoadingIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <div className="flex space-x-1">
    <span className={`inline-block ${className} bg-current rounded-full opacity-75 animate-bounce`}></span>
    <span className={`inline-block ${className} bg-current rounded-full opacity-75 animate-bounce-slow [animation-delay:0.2s]`}></span>
    <span className={`inline-block ${className} bg-current rounded-full opacity-75 animate-bounce [animation-delay:0.4s]`}></span>
  </div>
);
...
export const NewChatIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
